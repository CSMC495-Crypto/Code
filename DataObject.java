...
/**
 * object to store encrypted data and encryption key to be send between
 * communication parties to enable encrypted communications
 * 
 * @author Jonathan Wojack
 * @project Bank Encryption Application
 * @course CSMC 495
 * @updated on 02/19/2016 by Jonathan Wojack
 * @updated on 02/21/2016 by Olga Kazlova (added getSecretKey(),
 *          getEncryptionAlgorihtm(), getKey(), and getEncryptedData())
 * 
 * 
 */
public class DataObject implements java.io.Serializable {
	...
	public DataObject(byte[] encryptedData, SecretKey secretKey,
			String encryptionAlgorithm) {
	...
	/**
	 * getter for secretKey for encryption
	 * 
	 * @return secretKey
	 */
	...
	/**
	 * getter for encryptedData variable
	 * 
	...
	/**
	 * getter for type of encryptionAlgorithm
	 * 
	 * @return encryptionAlgorythm int
	 */
